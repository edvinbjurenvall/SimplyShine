...
const CampaignBooking = (() => {
  ...
  function buildPayload(values, date, time, params) {
    const payload = {
      ...
      paket: 'Välkomstpaket Hovås – 2 495 kr',
      ...
      meddelande: `[Hovås välkomstpaket: slutpris 2 495 kr per bil. Välkomstrabatten är redan avdragen. Sätesvård och glasförsegling ingår.]\n${values.meddelande || ''}`,
      kampanj: 'hovas-valkomstpaket', pris: 2495, valuta: 'SEK'
    };
  ...
  function init() {
    ...
    form.addEventListener('submit', async event => {
      ...
      try {
        ...
        document.dispatchEvent(new CustomEvent('campaign:booking-sent', { detail: { campaign: 'hovas-valkomstpaket', value: 2495, currency: 'SEK' } }));
      } catch (error) {
